...
void Output_function_NormalForce(){
  ...
  String Force_Info_L1=String(filtered_fg[0]);
  String Force_Info_L2=String(filtered_fg[1]);
  String Force_Info_R1=String(filtered_fg[2]);
  String Force_Info_R2=String(filtered_fg[3]);
